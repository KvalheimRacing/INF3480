...
### 3D vizualtzation program for robots
http://www.roboanalyzer.com/downloads.html

## Some solutions for the book
https://www.slideshare.net/edgarcampos33/solucionario-de-spong

## Singularities in Python
...
## Further on inverse kinematics, using numerical methods (past the level teached in the course)
- http://docs.ros.org/hydro/api/moveit_ikfast/html/doc/ikfast_tutorial.html
- http://openrave-users-list.185357.n3.nabble.com/Failed-to-create-IKFast-output-for-4DOF-manipulator-td4027816.html
- http://wiki.linuxcnc.org/cgi-bin/wiki.pl?Ikfast
- https://se.mathworks.com/help/robotics/ref/robotics.rigidbodytree-class.html
- https://se.mathworks.com/help/robotics/ref/robotics.inversekinematics-class.html
- https://se.mathworks.com/help/fuzzy/examples/modeling-inverse-kinematics-in-a-robotic-arm.html
- http://wiki.ros.org/urdf/Tutorials/Create%20your%20own%20urdf%20file
- http://docs.ros.org/kinetic/api/moveit_tutorials/html/doc/ikfast_tutorial.html#what-is-ikfast
- http://docs.ros.org/kinetic/api/moveit_tutorials/html/doc/trac_ik_tutorial.html
- https://bitbucket.org/traclabs/trac_ik.git
- http://irl.cs.duke.edu/pubs/trac-ik.pdf
- http://wiki.ros.org/Industrial/Tutorials/Create_a_Fast_IK_Solution
- http://www.orocos.org/kdl/installation-manual
- http://openrave.programmingvision.com/wiki/index.php/OctaveMATLAB
- http://openrave.org/docs/latest_stable/devel/
